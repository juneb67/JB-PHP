...
<html lang="en">
	...
	<body>
		...
		<div id="form-messages"><p>Please fill out the form below. I will get back to you as soon as possible.</p></div>
		<form id="ajax-contact" method="post" action="contact/mailer.php">
			...
			<div class="field form-group">
				...
				<input type="text" id="captcha" name="captcha" class="form-control dark" placeholder="Enter correct number">
				<br>
			</div>
