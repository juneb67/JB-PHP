...
<div class="row borderRow">
	...
	<div class="col-md-8 colSpace">
		...
		<p>Learning new languages and deepening my knowledge of familiar languages are activities I relish.</p>
	...
	<div class="col-md-4 colSpace">
		...
		<div class="picContainer">
			<img src="images/JBAbout.jpg" alt="Picture of June Bowman" title="June Bowman" 
			class="center-block img-rounded glow img-responsive" 
			width="400" height="400" longdesc="http://www.junebowman.com/images/JBAbout.jpg">
		</div>
		
		<div class="picContainer">
			<p>For more informaiton about me and to see details of my experience, please download my resume.</p>
			<p><a href="includes/JuneBowmanResume.pdf" title="View Resume" target="_blank">
			<span class="glyphicon glyphicon-file black iconAlign" aria-hidden="true"></span></a></p>
		</div>
	</div>
