					  ...
					  <div class="modal-body dark">
						  ...
						  <form role="form" id="contact" action="contact.php" method="post">
							...
							<div class="form-group">
							  ...
							  <input type="text" class="form-control dark" name="name" id="name" placeholder="Enter your name">
							</div>
							
							<div class="form-group">
							  <label for="email">Email:</label>
							  <input type="email" class="form-control dark" name="email" id="email" 
							  placeholder="Enter email" size="35">
							</div>
			  
						  <div class="form-group">
							<label>Comments:</label>
							<textarea name="comments" class="form-control dark" placeholder="Your comments here.." 
